...
app.post("/register/eth", async (req, res) => {
    ...
    const processedCoinbaseResponse = await coinbaseResponse.toJSON()
    const ethPerUSD = processedCoinbaseResponse.data.data.rates.ETH
    ...
    // processedEtherscanResponse = await etherscanResponse.toJSON()
