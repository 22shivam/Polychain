...
app.post("/register/sol", async (req, res) => {
    ...
    console.log(solanaExplorerResponse.data.result.meta)
    console.log(solanaExplorerResponse.data.result.transaction)
    console.log(solanaExplorerResponse.data.result.transaction.message.instructions)
    ...
    const solPaid = postBalanceSender - preBalanceSender - fee
