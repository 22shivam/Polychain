...
app.post("/register/eth", async (req, res) => {
    ...
    const etherscanResponse = await axios.get(`https://api-rinkeby.etherscan.io/api?module=proxy&action=eth_getTransactionByHash&txhash=${tx.hash}&apikey=${process.env.ETHERSCAN_API_KEY}`)
    console.log(etherscanResponse.data)
