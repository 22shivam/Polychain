...
const pubkeyfront = {
    _bn: 'd5bc49e38626b477ee1c76037bf70179cd8eb6768c36315bcee889c7dea5a1e8'
}

try {
    const newpubKey = new web3.PublicKey(pubkeyfront)
    console.log(newpubKey)
    console.log(newpubKey.toString())
    console.log(web3.PublicKey.decode(newpubKey.toBuffer()))
...
//         data: { address: address.data.toUpperCase(), blockchain: "sol" }
