...
app.post("/login/sol", async (req, res) => {
    ...
    console.log(new Uint8Array(signature) instanceof Uint8Array)
    console.log("public key:", naclUtil.decodeUTF8(address) instanceof Uint8Array)
    console.log(naclUtil.decodeUTF8(message) instanceof Uint8Array)

    const isValid = nacl.sign.detached.verify(naclUtil.decodeUTF8(message), new Uint8Array(signature), naclUtil.decodeUTF8(address))
