...
app.post("/login/sol", async (req, res) => {
    ...
    console.log(address)
    console.log(new Uint8Array(address))
    console.log(new Uint8Array(address) instanceof Uint8Array)
    console.log("public key:", address instanceof Uint8Array)
    console.log(naclUtil.decodeUTF8(message) instanceof Uint8Array)

    const isValid = nacl.sign.detached.verify(naclUtil.decodeUTF8(message), uint8Signature, naclUtil.decodeUTF8(address))
