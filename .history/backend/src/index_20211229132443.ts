...
app.post("/register/promo", async (req, res) => {
    ...
    // TODO: collect address and blockchain from JWT as opposed to input to avoid random people from spamming backend with addresses that dont exist. not a high priority problem as it only results in clogged username not really any other damage. as promo codes are limited
