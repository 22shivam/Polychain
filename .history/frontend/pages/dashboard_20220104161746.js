    ...
    return (
        <div className="flex flex-col w-screen">
            ...
            {userAccount.address ? hasUsername ?
                ...
                </main> : <CustomLabel className="font-medium flex flex-col items-center mt-4"><span>There is no username associated with this wallet address. Buy one <Link className='underline inline' href={`http://localhost:3000/`}>now!</Link></span></CustomLabel> : <CustomLabel className="font-medium flex flex-col items-center mt-4">Please login to access this page.</CustomLabel>}
        </div>
    )
}