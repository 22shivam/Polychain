    ...
    return (
        <div className="flex flex-col w-screen">
            ...
            <div id="main_body" className="flex flex-col justify-center items-center">
                <div id="main_content" className="my-6">
                    <h1 style={{ maxWidth: "650px", lineHeight: "4rem" }} class="text-5xl font-extrabold leading-10 tracking-tight text-gray-900 md:text-center sm:leading-none md:text-6xl lg:text-7xl text-center"><span class="inline md:block"><span class="relative mt-2 text-transparent bg-clip-text bg-gradient-to-br from-brand-primary-dark to-brand-primary-light md:inline-block ">receive crypto </span> with a simple,</span> shareable link</h1>
                    <div style={{ maxWidth: "500px" }} class="text-center mx-auto mt-5 md:mt-12 md:max-w-lg md:text-center lg:text-lg font-medium">Replace all your wallet addresses (bitcoin, ethereum, solana, deso) with a simple link! <span className=" text-transparent font-bold bg-clip-text bg-gradient-to-br from-brand-primary-dark to-brand-primary-light md:inline-block">Get one for free</span> by <a href="https://twitter.com/share?ref_src=twsrc%5Etfw" class="twitter-share-button" data-text="claiming my @polychainhq link!" data-url="https://polychain.tech/" data-related="polychainhq" data-show-count="false">tweeting</a><script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script> @polychainhq or buy for $5/yr</div>
                </div>
