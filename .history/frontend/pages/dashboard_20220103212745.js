        ...
        <div className="flex flex-col">
            ...
            {userAccount.address ? hasUsername ?
                <main id="dashboard" className='flex flex-col items-center mt-4'>
                    <CustomLabel className="mb-6 font-medium text-brand-primary-medium">View your profile live at <a className='underline' href={`http://localhost:3000/${username}`} target='_blank'>{`localhost:3000/${username}`}</a></CustomLabel>
