    ...
    return (
        <div>
            ...
            <div>
                ...
                <button onClick={handleSubmitEth} className="rounded-md shadow-lg text-blue-400 bg-slate-600 mr-4"> Pay now </button>
                ...
                <button onClick={async (e) => { await transferSOL(SOLpayValue, "AA6bqLgTzYPpFFH2R9XLdudibWcemLkKDRtZmPQEsEiS") }} className="rounded-md shadow-lg text-blue-400 bg-slate-600 mr-4"> Pay now </button>
