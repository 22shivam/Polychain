        ...
        <div className="flex flex-col w-screen">
            ...
            <div id="main_body" className="flex flex-col justify-center items-center">
                <div id="username" className="flex flex-col justify-center items-center">
                    <h1 class="text-5xl font-extrabold leading-10 tracking-tight text-left text-gray-900 md:text-center sm:leading-none md:text-6xl lg:text-7xl"><span class="inline md:block">receive crypto</span> <span class="relative mt-2 text-transparent bg-clip-text bg-gradient-to-br from-indigo-600 to-indigo-500 md:inline-block">with a simple shareable link</span></h1>
