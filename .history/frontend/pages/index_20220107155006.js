        ...
        <div className="flex flex-col w-screen h-screen">
            ...
            <div id="home" className="pt-20 flex flex-col justify-center items-center mb-40 sm:mb-48 md:mb-52">
                <div id="main_content" className="my-7">
                    <h1 style={{ maxWidth: "650px", lineHeight: "4rem" }} className="text-3xl font-extrabold tracking-tight text-gray-900 md:text-center sm:text-5xl text-center"><span className="inline md:block"><span className="relative mt-2 text-transparent bg-clip-text bg-gradient-to-br from-brand-primary-dark to-brand-primary-light block">receive <Typewriter
                        options={{
