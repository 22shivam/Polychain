...
export default function App() {
    ...
    return (
        <div className="flex flex-col">
            ...
            <br />
            <div id="main_body" class="flex-col">
                <div id="username" className="flex-col">
                    <h1> Enter Username </h1>
                    <div id="username_search_box" className="flex-row p-4 bg-orange-200 inline-block">
                        <span className="mx-1 inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-sm text-gray-700 font-semibold">localhost:3000/</span>
