    ...
    return (
        <div className="flex flex-col">
            ...
            {hasUsername ?
                ...
                </main> : <CustomLabel className="mb-6 font-medium">There is no username associated with this wallet address. Buy one <a className='underline' href={`http://localhost:3000/`} target='_blank'>now!</a></CustomLabel>}
        </div>
    )
}