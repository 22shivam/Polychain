            ...
            <div id="main_body" class="flex flex-col justify-center align-middle">
                <div id="username" className="flex flex-col justify-center align-middle">
                    <div class="flex justify-center rounded-3xl my-2">
                        <span class="border-2 border-r-0 text-sm rounded-l px-4 py-2 bg-gray-100 muted whitespace-no-wrap place-content-center ">localhost:3000/</span>
                    ...
                    <div id="promo_code" className="flex flex-row justify-center my-2">
                        <input value={promoCode} onChange={(e) => { setPromoCode(e.target.value) }} className="mx-4 border-2" type="text" placeholder="Enter Promo Code" />
