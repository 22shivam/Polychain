...
export default function App() {
    ...
    return (
        <div className="flex flex-col">
            <div className="flex flex-row shadow-md" id="nav_bar py-4">
                <div className="grow-0" id="left_nav_bar"> </div>
                <div className="grow" id="spacer">  </div>
                <div className="grow-0" id="right_nav_bar my-2">
                    {userAccount.address ?
                        <div>
                        ...
                        : (
                            <div>
                                <button className="bg-gray-200 text-gray-700 font-semibold py-2 px-4 rounded inline-flex items-center" onClick={ethLogin}>Login with Ethereum</button>
