        ...
        <div className="flex flex-col w-screen h-screen">
            ...
            <footer className="text-gray-700 bg-white body-font text-md">
                <div className="container flex items-center px-8 py-8 mx-auto max-w-7xl sm:flex-row">
                    ...
                    <p className="mt-4 text-gray-500 sm:ml-4 sm:pl-4 sm:border-gray-200 sm:mt-0 flex items-center justify-center">© 2021 &nbsp; <Link href="/" target="_self">Polychain</Link> &nbsp;
                    ...
                    <span id="spacer" className="grow"><a href="https://twitter.com/polychainhq" target="_blank" className="text-gray-400 hover:text-gray-500">
                        ...
                        <svg className="w-6 h-6 text-center" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
