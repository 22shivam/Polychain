    ...
    return (
        <div className="flex flex-col w-screen h-screen">
            ...
            <div class="px-8 mx-auto max-w-7xl lg:px-16">
                ...
                <div class="grid grid-cols-1 gap-0 md:grid-cols-2 md:gap-16">
                    <div>
                        <h5 class="mt-10 mb-3 font-semibold text-gray-900">What is Polychain?</h5>
                        <p>Polychain is a multi-chain payment solution that replaces your wallet addresses with a shareable link which you can use to receive payments, tips, etc. in several popular cryptocurrencies. </p>
