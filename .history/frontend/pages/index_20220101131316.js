            ...
            <div id="main_body" class="flex flex-col justify-center align-middle">
                <div id="username" className="flex flex-col justify-center align-middle">
                    <div class="flex justify-center my-2">
                        <span class="border border-gray-300 shadow-sm border-r-0 text-sm rounded-l-md px-4 py-2 bg-gray-100 muted whitespace-no-wrap font-semibold">localhost:3000/</span>
                        <input value={username} onChange={(e) => { setUsername(e.target.value) }} name="field_name" class="rounded-r px-4 py-2 w-40 border border-gray-300 shadow-sm border-l-0 place-content-center mr-2 input-placeholder" type="text" placeholder="Enter Username" />
                    ...
                    <div id="promo_code" className="flex flex-row justify-center my-2">
                        <input value={promoCode} onChange={(e) => { setPromoCode(e.target.value) }} className="mx-4 border border-gray-300 shadow-sm place-content-center rounded-md input-placeholder" type="text" placeholder="Enter Promo Code" />
