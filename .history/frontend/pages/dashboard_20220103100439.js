    ...
    return (
        <div className="flex flex-col">
            <ToastContainer
                ...
                draggable
            />
            <div className="grow-0 flex flex-row shadow-md py-1 px-2" id="nav_bar">
            ...
            <main id="dashboard" className='grow flex flex-col items-center justify-center'>
                Welcome to your dashboard! More coming soon....
                <br />
                <CustomInput type="text" value={bio} onChange={(e) => setBio(e.target.value)} placeholder="enter bio" />
                <CustomInput type="text" value={DESOAddress} onChange={(e) => setDESOAddress(e.target.value)} placeholder="enter deso address" />
                <CustomInput type="text" value={BTCAddress} onChange={(e) => setBTCAddress(e.target.value)} placeholder="enter btc address" />
                <CustomInput type="text" value={ETHAddress} onChange={(e) => setETHAddress(e.target.value)} placeholder="enter eth address" />
                <CustomInput type="text" value={SOLAddress} onChange={(e) => setSOLAddress(e.target.value)} placeholder="enter sol address" />
                <CustomInput type="file" onChange={uploadImage}
