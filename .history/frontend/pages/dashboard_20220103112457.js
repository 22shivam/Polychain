    ...
    return (
        <div className="flex flex-col">
            ...
            <main id="dashboard" className='flex flex-col items-center mt-4'>
                <CustomLabel className="mb-6 font-medium">View your profile live at <a className='underline hover:text-orange-300' href={`http://localhost:3000/${username}`} target='_blank'>{`localhost:3000/${username}`}</a></CustomLabel>
