            ...
            {userAccount.address ? hasUsername ?
                <div className="flex flex-row items-stretch flex-grow">
                    ...
                    <nav className='shadow-md'>
                        <ul className="flex flex-col mt-2 px-2">
                            {navigationItems.map((item) => {
                                let className = "transition duration-200 pl-2 pr-32 rounded-md py-2 font-semibold hover:bg-gray-50 text-gray-600" + (item.id == selectedNav ? " bg-gray-100" : "")
                                return (
                        ...
                        <div className='flex flex-col' id="form">
                            ...
                            <div className='flex flex-col md:flex-row'>
                                <div className='flex flex-col mt-4 items-start'>
                                    ...
                                    <CustomInput className="my-1 w-72" type="text" value={twitterUsername} onChange={(e) => setTwitterUsername((e.target.value))}
                                        placeholder="enter username" /></div>
                                <div className='flex flex-col mt-4 items-start'>
                                    <CustomLabel className="ml-2">Facebook Username:</CustomLabel>
                                    <CustomInput className="my-1 w-72" type="text" value={facebookUsername} onChange={(e) => setFacebookUsername((e.target.value))}
                                        placeholder="enter username" /></div>
                            </div>
                            <div className='flex flex-col mt-4 items-start'>
                                <CustomLabel className="ml-2">Instagram Username:</CustomLabel>
                                <CustomInput className="my-1 w-72" type="text" value={instagramUsername} onChange={(e) => setInstagramUsername((e.target.value))}
                                    placeholder="enter username" /></div>
                            <div className='flex flex-col mt-4 items-start'>
                                <CustomLabel className="ml-2">Pinterest Username:</CustomLabel>
                                <CustomInput className="my-1 w-72" type="text" value={pinterestUsername} onChange={(e) => setPinterestUsername((e.target.value))}
                                    placeholder="enter username" /></div>
                            <div className='flex flex-col mt-4 items-start'>
                                <CustomLabel className="ml-2">Reddit Username:</CustomLabel>
                                <CustomInput className="my-1 w-72" type="text" value={redditUsername} onChange={(e) => setRedditUsername((e.target.value))}
                                    placeholder="enter username" /></div>
                            <div className='flex flex-col mt-4 items-start'>
                                <CustomLabel className="ml-2">Youtube Username:</CustomLabel>
                                <CustomInput className="my-1 w-72" type="text" value={youtubeUsername} onChange={(e) => setYoutubeUsername((e.target.value))}
                                    placeholder="enter username" /></div>
                            <div className='flex flex-col mt-4 items-start'>
                                <CustomLabel className="ml-2">Linkedin Username:</CustomLabel>
                                <CustomInput className="my-1 w-72" type="text" value={linkedinUsername} onChange={(e) => setLinkedinUsername((e.target.value))}
                                    placeholder="enter username" /></div>
                            <div className='flex flex-col mt-4 items-start'>
                                <CustomLabel className="ml-2">Tiktok Username:</CustomLabel>
                                <CustomInput className="my-1 w-72" type="text" value={tiktokUsername} onChange={(e) => setTiktokUsername((e.target.value))}
                                    placeholder="enter username" /></div>
                            <div className='flex flex-col mt-4 items-start'>
                                <CustomLabel className="ml-2">Github Username:</CustomLabel>
                                <CustomInput className="my-1 w-72" type="text" value={githubUsername} onChange={(e) => setGithubUsername((e.target.value))}
                                    placeholder="enter username" /></div>
                            <div className='flex flex-col mt-4 items-start'>
                                <CustomLabel className="ml-2">Snapchat Username:</CustomLabel>
                                <CustomInput className="my-1 w-72" type="text" value={snapchatUsername} onChange={(e) => setSnapchatUsername((e.target.value))}
                                    placeholder="enter username" /></div>
