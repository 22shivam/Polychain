...
export default function App() {
    ...
    return (
        <div>
            {isRegistering ? 
            <button>Pay using Solana</button>
            <button>Pay using Ethereum</button>
                : <div><form onSubmit={registerUsername}>
                    ...
                    <button type="submit" className="rounded-md shadow-lg text-blue-400 bg-slate-600 mr-4"> Submit </button>
                </form>
