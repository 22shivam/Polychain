...
export default function App() {
    ...
    return (
        <div className="flex flex-col w-screen h-screen">
            ...
            <br />
            <div id="home" className="flex flex-col justify-center items-center mb-40 md:44 lg:mb-52">
            ...
            <div class="px-8 mx-auto max-w-7xl lg:px-16">
                ...
                <div class="grid grid-cols-1 gap-0 text-gray-600 md:grid-cols-2 md:gap-16">
                    <div>
                        ...
                        <p>Polychain is a multi-blockchain payment platform that lets you receive payments from anyone turn your wallet addresses into .</p>
                        <h5 class="mt-10 mb-3 font-semibold text-gray-900">How can I get access to it for Free?</h5>
                        <p>Just tweet anything @polychainhq on twitter to receive a promocode which can be redeemed for 1 year access to your own polychain page!</p>
                        <h5 class="mt-10 mb-3 font-semibold text-gray-900">What cryptocurrencies are currently supported?</h5>
                        <p>
                            Currently, we support Bitcoin, Ethereum, Solana, and DeSo. We will soon add support for ERC20 tokens and other popular cryptocurrencies. If you have any recommendations, then DM us @polychainhq on twitter.
                        </p>
