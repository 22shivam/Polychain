...
export default function App() {
    ...
    const solLogin = async (e) => {
        try {
            ...
            console.log(signedMessage.signature instanceof Uint8Array)
            console.log("publickey:", signedMessage.publicKey._bn.words)
            console.log(new Uint8Array(signedMessage.publicKey._bn.words))
            console.log("encoder", new TextEncoder().encode(provider.publicKey.toString()))
            console.log(signedMessage)
            console.log(web3.Struct.PublicKey.toBytes(provider.publicKey))
            const requestObject = {
