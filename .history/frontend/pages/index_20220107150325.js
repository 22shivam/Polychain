            ...
            <div class="px-8 mx-auto max-w-7xl lg:px-16 mb-40">
                ...
                <div class="grid grid-cols-1 gap-0 md:grid-cols-2 md:gap-16">
                    <div>
                        ...
                        <p>Just tweet anything @polychainhq on twitter to receive a promocode which can be redeemed for 1 year access to your own polychain link!</p>

                        <h5 class="mt-10 mb-3 font-semibold text-gray-900">How much does it cost?</h5>
                        <p>
                    ...
                    <div>
                        ...
                        <p>Apart from adding support for more cryptocurrencies, we also plan to make it easier for one to create personal tokens and airdrop it to whoever they want.</p>
                        ...
                        <h5 class="mt-10 mb-3 font-semibold text-gray-900">Have any other questions?</h5>
                        <p>Feel free to DM us @polychainhq on twitter</p>
