...
export default function App() {
    ...
    if (loading) {
        return <div type="button" class="flex justify-center items-center inline-flex items-center px-4 py-2 font-semibold leading-6 text-lg transition ease-in-out duration-150 cursor-not-allowed" disabled="">
