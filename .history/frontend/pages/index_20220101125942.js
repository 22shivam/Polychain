        ...
        <div className="flex flex-col">
            ...
            <div id="main_body" class="flex flex-col justify-center align-middle">
                <div id="username" className="flex flex-col justify-center align-middle">
                    <div class="flex justify-center rounded-3xl my-2 border border-2 ">
                        <span class="text-sm outline-2 rounded-l px-4 py-2 bg-gray-100 muted whitespace-no-wrap">localhost:3000/</span>
                        <input value={username} onChange={(e) => { setUsername(e.target.value) }} name="field_name" class="rounded-r px-4 py-2 w-40" type="text" placeholder="Enter Username" />
                    </div>
