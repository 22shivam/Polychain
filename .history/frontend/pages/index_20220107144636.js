            ...
            <div class="px-8 mx-auto max-w-7xl lg:px-16">
                ...
                <div class="grid grid-cols-1 gap-0 text-gray-600 md:grid-cols-2 md:gap-16">
                    <div>
                        ...
                        <p>Polychain is a multi-chain payment solution that replaces your wallet addresses into a shareable link which you can use to receive payments, tips, etc. in several popular cryptocurrencies.</p>
