                        ...
                        selectedNav == "4" ?
                            <div className='flex flex-col mb-20 pt-10 px-6 flex-1'>
                                ...
                                <div className='flex'>
                                    ...
                                    <CustomBrandedButton onClick={() => { window.open(`https://twitter.com/intent/tweet?&text=check out my polychain page and send crypto (btc, eth, sol, etc.) to me today! @polychainhq`, "_blank") }}>Tweet your Page <img src="/Twitter.svg" width='20'></img></CustomBrandedButton>
