        ...
        <div className="flex flex-col w-screen">
            ...
            <div id="main_body" className="flex flex-col justify-center items-center">
                <div id="main_content" className="my-6">
                    ...
                    <div style={{ maxWidth: "450px" }} class="text-center mx-auto mt-5 md:mt-12 md:max-w-lg md:text-center lg:text-lg font-medium">Replace all your wallet addresses (bitcoin, ethereum, solana, deso) with a simple link! <span className=" text-transparent font-bold bg-clip-text bg-gradient-to-br from-brand-primary-dark to-brand-primary-light md:inline-block">Get one for free</span> by tweeting @polychainhq or buy for $5/yr</div>
                </div>
