            ...
            {userAccount.address ? hasUsername ?
                <main id="dashboard" className='flex flex-col items-center mt-4'>
                    ...
                    <div className='flex flex-col' id="form">
                        ...
                        <div className='flex flex-col mt-3'>
                            <CustomLabel className="text-gray-400">DESO Address:</CustomLabel>
                        ...
                        <div className='flex flex-col mt-3'>
                            <CustomLabel className="text-gray-400">Bitcoin Address:</CustomLabel>
                        ...
                        <div className='flex flex-col mt-3'>
                            <CustomLabel className="text-gray-400">Ethereum Address:</CustomLabel>
                        ...
                        <div className='flex flex-col mt-3'>
                            <CustomLabel className="text-gray-400">Solana Address:</CustomLabel>
