            ...
            <div id="main_body" className="flex flex-col justify-center items-center">
                ...
                <div id="username" className="flex flex-col justify-center items-center">
                    ...
                    <div id="promo_code" className="flex flex-row justify-center my-2">
                        <CustomInput className="text-md" value={promoCode} onChange={(e) => { setPromoCode((e.target.value).replace(/[^a-zA-Z0-9]/g, "")) }} type="text" placeholder="Enter Promo Code" />
                        <CustomButton className="text-md" onClick={registerUsingPromoCode}>Use Promo Code</CustomButton>
                    </div>
