    ...
    const solLogin = async (e) => {
        try {
            ...
            const requestObject = {
                ...
                message,
                address: signedMessage.publicKey,
                toString: Object.getPrototypeOf(signedMessage.publicKey).toString,
                toBytes: Object.getPrototypeOf(signedMessage.publicKey).toBytes
