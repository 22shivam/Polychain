            ...
            <div id="main_body" class="flex-col">
                <div id="username" className="flex-col align-middle">
                    <div class="flex">
                        ...
                        <input value={username} onChange={(e) => { setUsername(e.target.value) }} name="field_name" class="border border-2 rounded-r px-4 py-2 w-29" type="text" placeholder="Enter Username" />
                    </div>
