            ...
            {userAccount.address ? hasUsername ?
                <main id="dashboard" className='flex flex-col items-center mt-10 w-screen justify-center'>
                    ...
                    <div className='flex flex-col w-screen items-center' id="form">
                        ...
                        {DESOAddress ? "" :
                            <CustomLabel className="text-gray-500 text-xs font-normal sm:text-sm">don&apos;t have an account yet? <a href="https://diamondapp.com?r=6xzkzfZt" className='underline' target="_blank" rel="noreferrer">sign up</a> now and get up to $5!</CustomLabel>}
                        <div className='flex flex-col mt-4 items-center sm:items-start'>
                        ...
                        <div className='flex flex-col mt-4 items-center sm:items-start'>
                            ...
                            <CustomInput className="my-1 w-68 sm:w-96" type="text" value={SOLAddress} onChange={(e) => setSOLAddress((e.target.value).replace(/[^a-zA-Z0-9]/g, ""))}
                                placeholder="enter sol address" /></div>
                        <div className='flex flex-col mt-4 mb-5 items-center sm:items-start'>
                            ...
                            <div className='flex flex-col items-center sm:items-start'>
                                ...
                                <div className="mx-4 w-68 sm:w-96 mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
