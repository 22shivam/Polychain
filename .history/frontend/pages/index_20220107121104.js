        ...
        <div className="flex flex-col w-screen">
            ...
            <div id="main_body" className="flex flex-col justify-center items-center">
                <div id="main_content" className="my-6">
                    ...
                    <div style={{ maxWidth: "450px" }} class="text-center mx-auto mt-5 md:mt-12 md:max-w-lg md:text-center lg:text-lg">Replace all your wallet addresses with a simple link! Get one for free by tweeting @polychainhq or buy for $5/yr</div>
                </div>
