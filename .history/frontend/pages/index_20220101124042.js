        ...
        <div className="flex flex-col">
            ...
            <div id="main_body" class="flex-col">
                <div id="username">
                    ...
                    <span className="mx-1 inline-flex justify-center w-full rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-sm text-gray-700 font-semibold">localhost:3000/</span>
