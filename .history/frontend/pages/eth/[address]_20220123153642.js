    ...
    return (
        <div className="flex flex-col items-center justify-center mx-4">
            ...
            <div id="card" className="flex flex-col justify-center rounded-xl border border-gray-300 shadow-sm p-3 pt-6 sm:p-6 bg-white">
                <div id="profile_header mt-6" className="flex flex-row items-start flex-grow">

                    {/* <Image width="60" className="rounded-full object-cover" height="60" src={profilePic}></Image> */}
                    <div className="flex flex-row items-center justify-between mb-5 ml-2 cursor-pointer flex-grow" onClick={() => { toastSuccess("Address copied!"); navigator.clipboard.writeText(address) }}>
