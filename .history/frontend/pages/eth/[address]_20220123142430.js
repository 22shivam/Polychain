            ...
            <div id="card" className="flex flex-col justify-center rounded-xl border border-gray-300 shadow-sm p-3 pt-6 sm:p-6 bg-white">
                <div id="profile_header mt-6" className="flex flex-row items-start">
                    ...
                    <div className="flex flex-col ml-2">
                        ...
                        <CustomLabel style={{ fontWeight: "500", maxWidth: "300px" }} className="px-0">"Insert Bio"</CustomLabel>
                    </div>
                </div>
                ...
                <div className="flex flex-row justify-center mb-6">
                    ...
                    <div className="flex flex-col">
                        <CurrencySelector currencies={currencies.length == 0 ? defaultCurrencies : currencies} selected={currencies[0]} setSelected={setSelectedCurrency}></CurrencySelector>
