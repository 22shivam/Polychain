            ...
            <div class="px-8 mx-auto max-w-7xl lg:px-16">
                ...
                <div class="grid grid-cols-1 gap-0 md:grid-cols-2 md:gap-16">
                    <div>
                        ...
                        <p>
                            Bitcoin, Ethereum, Solana, and DeSo are currently supported. ERC20 tokens and other popular cryptocurrencies will also be added to the platform in the near future. If you have any recommendations, then drop us a message @polychainhq on twitter.
                        </p>
