        ...
        <div className="flex flex-col">
            ...
            {userAccount.address ? hasUsername ?
                <main id="dashboard" className='flex flex-col items-center mt-4'>
                    <CustomLabel className="mb-6 font-medium">View your profile live at <a className='underline hover:text-brand-primary-medium transition-all' href={`http://localhost:3000/${username}`} target='_blank'>{`localhost:3000/${username}`}</a></CustomLabel>
                    <CustomLabel className="text-lg">Update Profile Information</CustomLabel>
                    <div className='flex flex-col' id="form">
                        ...
                        <CustomLabel className="text-gray-600 font-normal text-sm">don't have an account yet? <a href="https://diamondapp.com?r=6xzkzfZt" className='underline' target="_blank">sign up</a> now and get up to $5!</CustomLabel>
                        <div className='flex flex-col mt-3'>
                        ...
                        <div className='flex flex-row justify-around'>
                            <CustomButton className="px-6" onClick={updateInfo}>Save</CustomButton>
                        </div>
