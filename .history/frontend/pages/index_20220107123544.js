            ...
            <div id="main_body" className="flex flex-col justify-center items-center">
                ...
                <div id="username" className="flex flex-col justify-center items-center">
                    <div className="flex justify-center my-2">
                        <span className="border border-gray-300 shadow-sm border-r-0 rounded-l-md px-4 py-2 bg-brand-primary-light muted whitespace-no-wrap font-semibold">polychian.tech/</span>
