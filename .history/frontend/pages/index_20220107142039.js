        ...
        <div className="flex flex-col w-screen h-screen">
            ...
            <div id="home" className="flex flex-col justify-center items-center">
                <div id="main_content" className="my-8">
                    ...
                    /> </span> </span>with a simple, shareable link</h1>
