                        ...
                        <div className='flex flex-col' id="form">
                            ...
                            <CustomInput className="my-1" type="file" onChange={uploadImage}
                                ...
                                <div className='flex flex-col items-start mb-4'>
                                    ...
                                    <div className="mx-4 mb-4 w-72 sm:w-96 mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                                    ...
                                    <div className='flex flex-col mt-4 items-start self-center'>
