    ...
    return (
        <div className="flex flex-col w-screen h-screen">
            <ToastContainer
                ...
                style={{ maxWidth: "80%" }}
            />
            <div className="flex flex-row shadow-md py-1 px-0 sm:px-2 w-screen items-center fixed bg-white z-20" id="nav_bar">
                <div onClick={() => { router.push("http://localhost:3000/") }} className="grow-0 logo flex items-center justify-center cursor-pointer" id="left_nav_bar">
                    <img className="logo" src="/croppedPolychainLogo.png" alt="Polychain Logo" width="150" />
                </div>
            ...
            <div id="home" className="pt-20 flex flex-col justify-center items-center mb-40 sm:mb-48 md:mb-52">
                ...
                <div id="username" className="flex flex-col justify-center items-center">
                    <div className="flex justify-center my-3">
                        ...
                        <CustomInput value={username} onChange={(e) => { setUsername((e.target.value).replace(/[^a-zA-Z0-9]/g, "")) }} name="field_name" className="rounded-l-none ml-0 mr-2 sm:mr-4 input-placeholder" type="text" placeholder="Enter Username" />
            ...
            <footer className="text-gray-700 bg-white body-font text-md">
                <div className="container flex items-center px-8 py-8 mx-auto max-w-7xl sm:flex-row">
                    ...
                    <p className="sm:ml-4 font-medium sm:pl-4 sm:border-gray-200 sm:mt-0 flex items-center justify-center">{/*© 2021 &nbsp;*/} <Link href="/" target="_self">Polychain</Link> &nbsp;

                    </p>
                    <span id="spacer" className="grow"></span>
                    <span id="socials"><a href="https://twitter.com/polychainhq" target="_blank" className="text-gray-400 hover:text-gray-500">
