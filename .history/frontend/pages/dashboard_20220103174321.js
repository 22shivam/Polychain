                ...
                <main id="dashboard" className='flex flex-col items-center mt-4'>
                    ...
                    <div className='flex flex-col' id="form">
                        ...
                        <div className='flex flex-col mt-3'>
                            ...
                            <CustomLabel className="text-gray-600 font-normal text-sm">don't have an account yet? <a href="https://diamondapp.com?r=6xzkzfZt" className='underline' target="_blank">sign up</a> now and get $5!</CustomLabel>
