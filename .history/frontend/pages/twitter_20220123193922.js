    ...
    return (
        <Page>
            <div className='flex flex-col mb-20 pt-10 px-6 items-center'>
                ...
                <CustomLabel className="block text-center" style={{ maxWidth: "45ch" }}>Use this tool to extract ethereum addresses (including ens addresses) from replies to Tweets on Twitter</CustomLabel>
