        ...
        <div className="flex flex-col w-screen">
            ...
            {userAccount.address ? hasUsername ?
                <div className="flex flex-row items-stretch flex-start">
                    <nav className="shadow-md px-5 mt-1">
                        <ul className="flex flex-col">
                            <li className="
                            mx-1 rounded-md px-1.5 sm:px-4 py-2 sm:py-2 bg-white text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-indigo-500 font-semibold">
                                hello
                            </li>
