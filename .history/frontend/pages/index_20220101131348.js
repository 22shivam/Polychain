            ...
            <div id="main_body" class="flex flex-col justify-center align-middle">
                <div id="username" className="flex flex-col justify-center align-middle">
                    ...
                    <div id="promo_code" className="flex flex-row justify-center my-2">
                        <input value={promoCode} onChange={(e) => { setPromoCode(e.target.value) }} className="mx-4 border border-gray-300 shadow-sm placeholder-center rounded-md input-placeholder" type="text" placeholder="Enter Promo Code" />
