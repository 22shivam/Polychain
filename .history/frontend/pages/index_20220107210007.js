        ...
        <div className="flex flex-col w-screen h-screen">
            ...
            <footer className="text-gray-700 bg-white body-font text-md">
                <div className="container flex items-center px-8 py-8 mx-auto max-w-7xl sm:flex-row">
                    ...
                    <p className=" text-gray-500 sm:ml-4 sm:pl-4 sm:border-gray-200 sm:mt-0 flex items-center justify-center">© 2021 &nbsp; <Link href="/" target="_self">Polychain</Link> &nbsp;
                    ...
                    <span className="inline-flex justify-center space-x-5 sm:ml-auto sm:mt-0 sm:justify-start font-medium">


                        &nbsp; made with&nbsp;<span style={{ margin: "0px" }} className="text-center text-red-600 text-lg">&hearts;</span> &nbsp;in india
                    </span>
                </div>
            </footer>
