...
export default function App() {
    ...
    return (
        <div className="flex flex-col w-screen h-screen">
            ...
            <br />
            <div id="home" className="pt-20 flex flex-col justify-center items-center mb-20 sm:mb-48 md:mb-52">
                <div id="main_content" className="my-7">
                    <h1 style={{ maxWidth: "650px", lineHeight: "4rem" }} className="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-center sm:text-5xl text-center"><span className="inline sm:block"><span className="relative mt-2 text-transparent bg-clip-text bg-gradient-to-br from-brand-primary-dark to-brand-primary-light block">receive <Typewriter
                        options={{
                    ...
                    <div style={{ maxWidth: "500px" }} className="text-center mx-auto mt-7 sm:mt-8 md:max-w-lg md:text-center sm:text-lg font-medium">Replace all your wallet addresses with a simple link! <span className=" text-transparent font-bold bg-clip-text bg-gradient-to-br from-brand-primary-dark to-brand-primary-light sm:inline-block">Get one for free</span> by <a href="https://twitter.com/intent/tweet?original_referer=https://polychain.tech/&ref_src=twsrc%5Etfw%7Ctwcamp%5Ebuttonembed%7Ctwterm%5Eshare%7Ctwgr%5E&related=polychainhq&text=claiming%20my%20%40polychainhq%20link!&url=https%3A%2F%2Fpolychain.tech%2F" target="_blank">tweeting</a> @polychainhq or buy for $5/yr</div>
                </div>
            ...
            <div className="px-8 mx-auto max-w-7xl lg:px-16 mb-40">
                <h2 className="text-center sm:text-left pt-4 text-xl font-bold md:text-3xl" id="faq" >Frequently Asked Questions</h2>
            ...
            <footer className="text-gray-700 bg-white body-font text-md">
                <div className="container flex flex-col items-center px-8 py-8 mx-auto max-w-7xl sm:flex-row">
                    ...
                    <p className="mt-4 text-gray-500 sm:ml-4 sm:pl-4 sm:border-gray-200 sm:mt-0 flex items-center">© 2021 &nbsp; <Link href="/" target="_self">Polychain</Link> &nbsp;

                    </p>
                    <span id="spacer" className="grow"></span>
                    <span id="socials"></span>
                    <span id="spacer" className="grow"><a href="https://twitter.com/polychainhq" target="_blank" className="text-gray-400 hover:text-gray-500">
                        <span className="sr-only">Twitter</span>
                        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84"></path>
                        </svg>
                    </a></span>
                    <span className="inline-flex justify-center mt-4 space-x-5 sm:ml-auto sm:mt-0 sm:justify-start font-medium">
