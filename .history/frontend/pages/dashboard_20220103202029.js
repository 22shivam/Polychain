...
function maybePublicKey(s) {
    try {
        return web3.PublicKey.isOnCurve(new web3.PublicKey(s).toBytes());
    } catch (e) {
        return null;
    }
}
...
export default function UserDashboard() {
    ...
    const updateInfo = async (e) => {
        ...
        console.log('is public key', maybePublicKey(SOLAddress))

        if (!web3.PublicKey.isOnCurve(SOLAddress) && SOLAddress) {
