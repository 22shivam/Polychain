            ...
            {userAccount.address ? hasUsername ?
                <div className="flex flex-row items-stretch flex-grow">
                    ...
                    {selectedNav == 1 ? <main id="dashboard" className='flex flex-col mb-20 pt-10 px-6 flex-1'>
                        <CustomLabel className="text-xl smtext-2xl mb-3">Your Username:<Link className="cursor-pointer flex" href={`/${username}`}><CustomLabel className="cursor-pointer smtext-2xl text-xl mx-0 px-0 font-normal flex">{username}<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
