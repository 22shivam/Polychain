            ...
            {userAccount.address ? hasUsername ?
                <main id="dashboard" className='flex flex-col items-center mt-10 justify-center'>
                    ...
                    <div className='flex flex-col w-screen items-center' id="form">
                        ...
                        {DESOAddress ? "" :
                            <CustomLabel style={{ width: "350px" }} className="text-gray-500 font-normal text-sm">don&apos;t have an account yet? <a href="https://diamondapp.com?r=6xzkzfZt" className='underline' target="_blank" rel="noreferrer">sign up</a> now and get up to $5!</CustomLabel>}
                        <div className='flex flex-col mt-4'>
