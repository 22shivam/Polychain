...
export default function Brand() {
    ...
    const script = `<script src="http://polychain.tech/embed.prod.bundle.js" data-user="${username}" data-text="${text}" data-style="${style}"></script>`

    return (
        <Page className="flex flex-col items-center">
            <CustomLabel className="text-xl sm:text-2xl mb-4 mt-6">Get an embeddable Polychain button for your website today!</CustomLabel>
