        ...
        <div className="flex flex-col">
            ...
            <div id="main_body" class="flex-col">
                <div id="username" className="flex-col align-middle">
                    <div class="flex">
                        <span class="text-sm border border-2 rounded-l px-4 py-2 bg-gray-300 whitespace-no-wrap">localhost:3000/</span>
                        <input value={username} onChange={(e) => { setUsername(e.target.value) }} name="field_name" class="border border-2 rounded-r px-4 py-2 w-full" type="text" placeholder="Enter Username" />
                    </div>
