            ...
            {userAccount.address ? hasUsername ?
                <main id="dashboard" className='flex flex-col items-center mt-4'>
                    ...
                    <div className='flex flex-col' id="form">
                        ...
                        <div className='flex flex-col mt-3'>
                            <CustomLabel className="text-gray-500">DESO Address:</CustomLabel>
                        ...
                        <div className='flex flex-col mt-3'>
                            <CustomLabel className="text-gray-500">Bitcoin Address:</CustomLabel>
                        ...
                        <div className='flex flex-col mt-3'>
                            <CustomLabel className="text-gray-500">Ethereum Address:</CustomLabel>
                        ...
                        <div className='flex flex-col mt-3'>
                            <CustomLabel className="text-gray-500">Solana Address:</CustomLabel>
