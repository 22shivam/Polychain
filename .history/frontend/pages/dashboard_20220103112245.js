    ...
    return (
        <div className="flex flex-col">
            ...
            <main id="dashboard" className='flex flex-col items-center mt-4'>
                <CustomLabel className="mb-6 font-semibold ">View your profile live at {`localhost:3000/${username}`}</CustomLabel>
                <CustomLabel className="text-lg">Profile Information</CustomLabel>
