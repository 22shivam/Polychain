    ...
    return (
        <div>
            ...
            <div>
                ...
                <button onClick={async () => { await transferEth({ ether: ETHpayValue, addr: RECIEPIENT_ETH_ADDRESS }) }} className="rounded-md shadow-lg text-blue-400 bg-slate-600 mr-4"> Pay now </button>
