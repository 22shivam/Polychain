...
export default function UserDashboard() {
    ...
    const updateInfo = async (e) => { // TODO:add try catch
        console.log(ETHAddress.toUpperCase())
        console.log(SOLAddress.toUpperCase())

        if (userAccount.blockchain === "eth" && userAccount.address.toUpperCase() !== ETHAddress.toUpperCase() || userAccount.blockchain === "sol" && userAccount.address.toUpperCase() !== SOLAddress) {
