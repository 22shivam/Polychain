                ...
                <div className="flex flex-row items-stretch flex-grow">
                    ...
                    {selectedNav == 1 ? <main id="dashboard" className='flex flex-col mb-20 pt-10 px-6 flex-1'>
                        <div className='flex items-center align-items-center'>
                            <CustomLabel className="text-xl smtext-2xl">Your Username:
                            </CustomLabel>
                            <Link className="cursor-pointer flex align-middle items-center align-items-center" href={`/${username}`}>
                                <div className='flex mt-2 align-items-center items-center cursor-pointer'>
                                    <CustomLabel className="underline cursor-pointer smtext-2xl text-xl mx-0 px-0 font-normal hover:text-brand-primary-medium hover:underline">{username}</CustomLabel>
