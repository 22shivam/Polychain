                            ...
                            <CustomInput className="my-1" type="file" onChange={uploadImage}
                                ...
                                <div className='flex flex-col items-start mb-4'>
                                    ...
                                    <div className='flex flex-col mt-4 items-center ml-3 self-stretch p-4 mb-3 border-2 border-gray-300 border-dashed rounded-md'>
                                        ...
                                        <img class="mx-auto w-20 mb-4 self-center" src="https://user-images.githubusercontent.com/507615/54591670-ac0a0180-4a65-11e9-846c-e55ffce0fe7b.png" alt="no data" />
                                        {profilePic}
