            ...
            <div id="main_body" class="flex flex-col justify-center align-middle">
                <div id="username" className="flex flex-col justify-center align-middle">
                    <div class="flex justify-center my-2">
                        ...
                        <input value={username} onChange={(e) => { setUsername(e.target.value) }} name="field_name" class="rounded-r px-4 py-2 w-40 border border-gray-300 shadow-sm border-l-0 place-content-center" type="text" placeholder="Enter Username" />
