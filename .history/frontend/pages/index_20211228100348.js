...
const startPayment = async ({ ether, addr }) => {
    try {
        ...
        const accounts = window.ethereum.providers[2].request({ method: "eth_requestAccounts" })
        // const providersObject = await detectEthereumProvider();
        // const providers = providersObject.providers
        // console.log(providers[0] == providers[1])
