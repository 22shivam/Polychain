        ...
        <div className="flex flex-col w-screen">
            ...
            <div id="main_body" className="flex flex-col justify-center items-center">
                <div id="username" className="flex flex-col justify-center items-center">
                    ...
                    <div style={{ maxWidth: "650px", lineHeight: "4rem" }} class="mx-auto mt-5 text-gray-500 md:mt-12 md:max-w-lg md:text-center lg:text-lg">Replace all your wallet addresses with a simple link! Get one for free by tweeting @polychainhq or buy for $5/yr</div>
