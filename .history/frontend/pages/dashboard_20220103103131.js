    ...
    return (
        <div className="flex flex-col">
            ...
            <main id="dashboard" className='flex flex-col items-center mt-4'>
                ...
                <div className='grid grid-cols-5 gap-3'>
                    <CustomLabel>Solana Address:</CustomLabel>
                    <CustomInput className="my-1" type="file" value={SOLAddress} onChange={(e) => setSOLAddress(e.target.value)} placeholder="enter sol address" />
                </div>
                <div className='grid grid-cols-5 gap-3'>
                ...
                <div className='grid grid-cols-5 gap-3'>
                    <CustomLabel className="block text-sm font-medium text-gray-700">Profile Picture:</CustomLabel>
