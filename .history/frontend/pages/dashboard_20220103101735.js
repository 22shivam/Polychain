    ...
    return (
        <div className="flex flex-col">
            ...
            <main id="dashboard" className='flex flex-col items-center mt-4'>
                ...
                <br />
                <div className='flex flex-row'>
                    <CustomLabel className="w-1/3">Bio:</CustomLabel>
                    <CustomInput className="my-1 w-2/3" type="text" value={bio} onChange={(e) => setBio(e.target.value)} placeholder="enter bio" />
                </div>
                <div className='flex flex-row'>
                    <CustomLabel className="w-1/3">DESO Address:</CustomLabel>
                    <CustomInput className="my-1 w-2/3" type="text" value={DESOAddress} onChange={(e) => setDESOAddress(e.target.value)} placeholder="enter deso address" />
                </div>
                <div className='flex flex-row'>
