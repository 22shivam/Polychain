            ...
            {userAccount.address ? hasUsername ?
                <main id="dashboard" className='flex flex-col items-center mt-4'>
                    ...
                    <div className='flex flex-col' id="form">
                        ...
                        {DESOAddress ? "" :
                            <CustomLabel className="text-gray-500 font-normal text-sm basis-1">don't have an account yet? <a href="https://diamondapp.com?r=6xzkzfZt" className='underline' target="_blank">sign up</a> now and get up to $5!</CustomLabel>}
                        <div className='flex flex-col mt-4'>
