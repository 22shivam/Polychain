        ...
        <div className="flex flex-col w-screen h-screen">
            ...
            <div id="home" className="pt-20 flex flex-col justify-center items-center mb-40 md:44 lg:mb-52">
                <div id="main_content" className="my-7">
                    ...
                    <div style={{ maxWidth: "500px" }} className="text-center mx-auto mt-8 md:max-w-lg md:text-center lg:text-lg font-medium">Replace all your wallet addresses with a simple link! <span className=" text-transparent font-bold bg-clip-text bg-gradient-to-br from-brand-primary-dark to-brand-primary-light md:inline-block">Get one for free</span> by <a href="https://twitter.com/intent/tweet?original_referer=https://polychain.tech/&ref_src=twsrc%5Etfw%7Ctwcamp%5Ebuttonembed%7Ctwterm%5Eshare%7Ctwgr%5E&related=polychainhq&text=claiming%20my%20%40polychainhq%20link!&url=https%3A%2F%2Fpolychain.tech%2F" target="_blank">tweeting</a> @polychainhq or buy for $5/yr</div>
                </div>
