            ...
            {userAccount.address ? hasUsername ?
                <div className="flex flex-row items-stretch">
                    <nav className='shadow-md'>
                        <ul className="flex flex-col mt-2 px-2 h-screen">
                            {navigationItems.map((item) => {
                                let className = "pl-5 pr-32 rounded-md py-2 font-semibold hover:bg-gray-50 text-gray-600" + (item.id == selectedNav ? " bg-gray-100" : "")
                                return (
                            ...
                            <li className='flex-grow' id="spacer"></li>


                        </ul>
                    </nav>
                    {selectedNav == 1 ? <main id="dashboard" className='flex flex-col mt-4 mb-20 ml-8'>
