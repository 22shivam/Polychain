            ...
            <div id="main_body" class="flex flex-col justify-center align-middle">
                <div id="username" className="flex flex-col justify-center align-middle">
                    <div class="flex justify-center rounded-3xl my-2">
                        <span class="text-sm border border-2 rounded-l px-4 py-2 bg-gray-100 muted whitespace-no-wrap">localhost:3000/</span>
                    ...
                    <div id="promo_code" className="flex flex-row justify-center my-2">
                        <input value={promoCode} onChange={(e) => { setPromoCode(e.target.value) }} className="mr-4 ml-4 border-4" type="text" placeholder="Enter Promo Code" />
