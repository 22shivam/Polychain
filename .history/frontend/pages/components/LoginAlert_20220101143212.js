...
export default function LoginAlert({ message, success }) {
    if (success) {
        return (<div class="absolute top-2 animate-bounce bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded inline-block w-70 self-center" role="alert">
