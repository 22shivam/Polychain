            ...
            {({ open }) => (
                <>
                    ...
                    <div className="mt-1 relative">
                        <Listbox.Button className="relative w-full bg-white border border-gray-300 rounded-md shadow-sm pl-3 pr-10 py-5 text-left cursor-default focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                            <span className="flex items-center">
                                <Image width={iconSize} height={iconSize} src={selected.avatar} alt="" className="flex-shrink-0 h-6 w-6 rounded-full" />
