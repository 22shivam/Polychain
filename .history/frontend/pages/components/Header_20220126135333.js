        ...
        <div className="flex flex-row shadow-md py-1 px-2 w-screen" id="nav_bar">
            ...
            <div className="grow-0 my-2 sm:mr-4 flex" id="right_nav_bar">
                {userAccount.address ?
                    ...
                    : (
                        <div>
                            <DropDownComponent label3="Wallet Connect" label3onClick={walletConnect} primaryLabel="Login" label1="Ethereum" label2="Solana" label1onClick={ethLogin} label2onClick={solLogin} />
                        </div>
                    )}
