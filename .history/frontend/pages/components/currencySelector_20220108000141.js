            ...
            {({ open }) => (
                <>
                    ...
                    <div className=" relative">
                        <Listbox.Button className="relative w-full bg-white border border-gray-300 flex justify-between items-center rounded-md shadow-sm px-3 sm:px-3 py-2.5 sm:py-3.5 text-left cursor-default focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                            ...
                            <span className="ml-1 sm:ml-3  flex items-center pr-2 pointer-events-none">
