            ...
            <div className="flex flex-col items-center justify-center mx-4">
                ...
                <div id="card" className="flex flex-col justify-center rounded-xl border border-gray-300 shadow-sm bg-white">
                    ...
                    <div className="flex p-3 sm:p-6">
                        <div className="styleDrop mr-1"><DropDownComponent primaryLabel={(this.state.style == "regular") ? "Light" : "Dark"} label1="Dark" label2="Light" label1onClick={this.changeRegular} label2onClick={this.changeInverted} /></div>
