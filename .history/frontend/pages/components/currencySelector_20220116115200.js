                ...
                <>
                    ...
                    <div className=" relative">
                        ...
                        <Transition
                            ...
                            leaveTo="opacity-0"
                        >
                            <Listbox.Options className="absolute z-10 mt-1 w-full bg-white shadow-lg max-h-56 rounded-md py-1 ring-1 ring-black ring-opacity-5 overflow-auto focus:outline-none text-xs sm:text-sm">
                                    ...
                                    <Listbox.Option
                                        ...
                                        className={({ active }) =>
                                            classNames(
                                                ...
                                                'cursor-default select-none relative py-2 pl-1.5 sm:pl-3 pr-9'
                                            )
                                        }
                                        value={person}
                                    >
