            ...
            {({ open }) => (
                <>
                    ...
                    <div className=" relative">
                        <Listbox.Button className="relative w-full bg-white border border-gray-300 flex justify-between items-center rounded-md shadow-sm px-2 py-4 text-left cursor-default focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
