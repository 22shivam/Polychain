            ...
            <div className="flex flex-row shadow-md" id="nav_bar">
                ...
                <div className="grow-0 my-2 mr-4 flex" id="right_nav_bar">
                    {userAccount.address ?
                        ...
                        : (
                            <div>
                                <DropDownComponent label1="Ethereum" label2="Solana" label1onClick={ethLogin} label2onClick={solLogin} />
                            </div>
                        )}
            ...
            <div id="main_body" class="flex flex-col justify-center align-middle">
                <div id="username" className="flex flex-col justify-center align-middle">
                    <div class="flex justify-center my-2">
                        <span class="border-2 border-r-0 text-sm rounded-l px-4 py-2 bg-gray-100 muted whitespace-no-wrap">localhost:3000/</span>
                        <input value={username} onChange={(e) => { setUsername(e.target.value) }} name="field_name" class="rounded-r px-4 py-2 w-40 border-2 border-l-0 place-content-center" type="text" placeholder="Enter Username" />
                        <DropDownComponent label1="Ethereum" label2="Solana" label1onClick={registerUsingEthereum} label2onClick={registerUsingSolana} />
                    </div>
                    ...
                    <div id="promo_code" className="flex flex-row justify-center my-2">
                        <input value={promoCode} onChange={(e) => { setPromoCode(e.target.value) }} className="mx-4 border-2 place-content-center rounded-l" type="text" placeholder="Enter Promo Code" />
                        <CustomButton onClick={registerUsingPromoCode}>Use Promo Code</CustomButton>
                    </div>

                    <div id="payment_options" className="flex flex-row justify-center">
                        <CustomButton className="" onClick={registerUsingEthereum}>Buy using Ethereum</CustomButton>
                        <CustomButton className="" onClick={registerUsingSolana}>Buy using Solana</CustomButton>
                    </div>
