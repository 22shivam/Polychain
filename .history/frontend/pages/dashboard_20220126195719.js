            ...
            {userAccount.address ? hasUsername ?
                <div className="flex flex-row items-stretch flex-grow">
                    ...
                    {selectedNav == 1 ? <main id="dashboard" className='flex flex-col mb-20 pt-10 px-6 flex-1'>
                        <CustomLabel className="text-xl smtext-2xl mb-3">Your Username:<Link className="cursor-pointer" href={`/${username}`}><CustomLabel className="smtext-2xl text-xl mx-0 px-0 font-normal">{username}</CustomLabel></Link></CustomLabel>
