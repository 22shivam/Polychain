        ...
        <div className="flex flex-col w-screen">
            ...
            <div id="main_body" className="flex flex-col justify-center items-center">
                <div id="username" className="flex flex-col justify-center items-center">
                    <h1 style={{ maxWidth: "700px", lineHeight: "10rem" }} class="text-5xl font-extrabold leading-10 tracking-tight text-left text-gray-900 md:text-center sm:leading-none md:text-6xl lg:text-7xl text-center"><span class="inline md:block"><span class="relative mt-2 text-transparent bg-clip-text bg-gradient-to-br from-brand-primary-dark to-brand-primary-light md:inline-block ">receive crypto </span> with a simple,</span> <span class="relative mt-2 text-transparent bg-clip-text bg-gradient-to-br from-brand-primary-dark to-brand-primary-light md:inline-block">shareable link</span></h1>
                    <div class="mx-auto mt-5 text-gray-500 md:mt-12 md:max-w-lg md:text-center lg:text-lg">Replace all your wallet addresses with a simple link! Get one for free by tweeting @polychainhq or buy for $5/yr</div>
                    <CustomLabel className="text-4xl" style={{ maxWidth: "600px" }}>receive crypto (btc, eth, sol, deso, etc.) using a simple, shareable link!</CustomLabel>
