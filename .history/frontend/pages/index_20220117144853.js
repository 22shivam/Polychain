        ...
        <div className="flex flex-col w-screen h-screen">
            ...
            <div id="home" className="pt-20 flex flex-col justify-center items-center mb-40 sm:mb-48 md:mb-52">
                ...
                <div id="username" className="flex flex-col justify-center items-center">
                    ...
                    <a href="https://www.producthunt.com/posts/polychain?utm_source=badge-featured&utm_medium=badge&utm_souce=badge-polychain" target="_blank" className="mt-2"><img src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=327134&theme=light" alt="Polychain - Send and receive crypto using a simple, shareable link | Product Hunt" style={{ width: "250px", height: "54px" }} width="250" height="54" /></a>
                </div>
            </div>
