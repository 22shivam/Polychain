    ...
    return (
        <div className="flex flex-col">
            ...
            <div className="flex flex-row shadow-md py-1 px-2" id="nav_bar">
                <div className="grow-0 flex items-center justify-center cursor-pointer" id="left_nav_bar">
                    <img onClick={() => { window.open("http://localhost:3000/") }} classname="" src="/croppedPolychainLogo.png" alt="Polychain Logo" width="150" />
                </div>
