...
QRCode.toCanvas(canvas, 'bitcoin:3DBGwFbBoj7FjBFcbVi8hFcpmCjPhCY62X', function (error) {
    if (error) console.error(error)
    console.log('success!');
})

export default function App() {
    const [qrCode, setQrCode] = useState(generateQR("bitcoin:3DBGwFbBoj7FjBFcbVi8hFcpmCjPhCY62X"))
