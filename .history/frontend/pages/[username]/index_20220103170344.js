            ...
            <div id="card" className="flex flex-col justify-center rounded-xl border border-gray-300 shadow-sm p-6 bg-white">
                ...
                <div class="flex justify-center my-8">
                    ...
                    <div className="flex flex-col">
                        ...
                        <CustomLabel className="text-gray-500 text-normal mx-0 px-0">{USDPerCurrency * payValue}</CustomLabel>
                    </div>
                    ...
                    <div className="flex flex-col">
                        ...
                        <CustomLabel className="text-gray-500 text-normal px-0"> 1 {selectedCurrency.name} = ~{USDPerCurrency}</CustomLabel>
                    </div>
