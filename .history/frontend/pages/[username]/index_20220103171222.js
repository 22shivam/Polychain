...
export default function UserPayment() {
    ...
    return (
        ...
        <div className="flex flex-col items-center justify-center h-screen">
            ...
            <div id="card" className="flex flex-col justify-center rounded-xl border border-gray-300 shadow-sm p-4 bg-white">
                ...
                <div class="flex justify-center mt-6">
                    ...
                    <div className="flex flex-col">
                        ...
                        <CustomLabel className="text-gray-500 text-normal px-0">USD {USDPerCurrency * payValue}</CustomLabel>
                    </div>
                    ...
                    <div className="flex flex-col">
                        ...
                        <CustomLabel className="text-gray-500 text-normal px-0"> 1 {selectedCurrency.name} = ~ USD {USDPerCurrency}</CustomLabel>
                    </div>

                </div>
                {selectedCurrency.name == "BTC" ? <img className="" src={qrCode}></img> : ""}
                <CustomButton onClick={transferAmount} className="my-4">Pay</CustomButton>
