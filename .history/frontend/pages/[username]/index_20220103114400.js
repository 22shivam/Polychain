        ...
        <div className="flex flex-col items-center justify-items-center">
            <div id="card" className="flex flex-col rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white">
                ...
                <div class="flex justify-center my-2">
                    ...
                    <CustomInput placeholder="Amount" value={username} onChange={(e) => { setUsername(e.target.value) }} name="field_name" className="rounded-l-none ml-0 input-placeholder" type="text" />
