    ...
    return (
        ...
        <div className="flex flex-col items-center justify-center h-screen">
            ...
            <div id="card" className="flex flex-col justify-center rounded-xl border border-gray-300 shadow-sm p-6 bg-white">
                <div id="profile_header mt-8" className="flex flex-row">
                ...
                <div class="flex justify-center mt-6">
                    ...
                    <div className="flex flex-col">
                        ...
                        <CustomLabel className="text-gray-500 text-normal mx-0 px-0">USD {USDPerCurrency * payValue}</CustomLabel>
                    </div>
                ...
                {selectedCurrency.name == "BTC" ? <img className="mt-2" src={qrCode}></img> : ""}
                <CustomButton onClick={transferAmount} className="mb-8 mt-6">Pay</CustomButton>
