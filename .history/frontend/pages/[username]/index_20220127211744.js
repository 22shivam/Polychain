                    ...
                    <div id="card" className="flex flex-col justify-center rounded-xl border border-gray-300 shadow-sm p-3 pt-6 sm:p-6 bg-white">
                        ...
                        {active == 3 ? ethNFTs.map(
                            (nft, index) => {
                                ...
                                return (
                                    <div className="m-4 mx-6 shadow-md rounded-3xl overflow-hidden">
                                        ...
                                        <div className="flex flex-row justify-between items-center px-4">
                                            <CustomLabel style={{ fontSize: "1.5rem" }} className="my-4">{nft.name}</CustomLabel>
                                            <a target="_blank" rel="noreferrer" href={`https://opensea.io/assets/${nft.contractAddress}/${nft.tokenId}`}>
                                                <svg className='cursor-pointer h-6 w-6 mr-3' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
