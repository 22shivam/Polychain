            ...
            <div id="card" className="flex flex-col justify-center rounded-xl border border-gray-300 shadow-sm p-6 bg-white">
                ...
                <div class="flex justify-center my-6">
                    ...
                    <div className="flex flex-col">
                        ...
                        <CustomLabel className="text-gray-500 text-normal mx-0 px-0">USD {parseFloat((USDPerCurrency * payValue)).toFixed(4)}</CustomLabel>
                    </div>
                    ...
                    <div className="flex flex-col">
                        ...
                        <CustomLabel className="text-gray-500 text-normal px-0"> 1 {selectedCurrency.name} = ~ USD {parseFloat(USDPerCurrency).toFixed(4)}</CustomLabel>
                    </div>
