...
export default function UserPayment() {
    ...
    return (
        ...
        <div className="flex flex-col items-center justify-center h-screen">
            <CustomLabel onClick={() => { window.open("http://localhost:3000/", target = "_blank") }} className="my-10">LocalHost</CustomLabel>
            <div id="card" className="flex flex-col justify-center rounded-md border border-gray-300 shadow-sm p-6 bg-white">
                <div id="profile_header" className="flex flex-row mb-4">
            ...
            <CustomButton onClick={() => { window.open("http://localhost:3000/", target = "_blank") }} className="my-10">Create your own!</CustomButton>
            <div id="spacer" className="mb-10 hidden">hiddemn</div>
            <div></div>
