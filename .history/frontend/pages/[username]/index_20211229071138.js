    ...
    return (
        <div>
            ...
            <div>
                ...
                <button onClick={(e) => { transferERC20(e, TOKEN_ADDRESS, TOKEN_ABI, RECIEPIENT_ETH_ADDRESS) }} className="rounded-md shadow-lg text-blue-400 bg-slate-600 mr-4"> Pay now </button>
