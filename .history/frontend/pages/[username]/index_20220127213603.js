        ...
        <Page>
            <div className="flex flex-col align-items-center items-center mt-16">
                ...
                {loading ? <Loading /> : accountExists ?
                    <div id="card" className="transition duration-300 flex flex-col justify-center rounded-xl border border-gray-300 shadow-sm p-3 pt-6 sm:p-6 mx-8 sm:mx-32 bg-white md:mx-40 lg:mx-60">
                        ...
                        {active == 3 ?
                            <div className="mt-4 flex duration-300 flex-wrap justify-center">
                                {ethNFTs.map(
                                    (nft, index) => {
                                            ...
                                            <div className="m-4 mb-8 mx-6 shadow-md rounded-3xl overflow-hidden">
                                                ...
                                                <div className="flex flex-row justify-between items-center my-6">
                                                    ...
                                                    <a className="mr-2" target="_blank" rel="noreferrer" href={`https://opensea.io/assets/${nft.contractAddress}/${nft.tokenId}`}>
                                                        <svg className='cursor-pointer h-6 w-6' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 34 34" stroke="currentColor">
