        ...
        <div className="flex flex-col items-center justify-center mx-4">
            ...
            {loading ? <div type="button" className="inline-flex items-center px-4 py-2 font-semibold leading-6 text-lg transition ease-in-out duration-150 cursor-not-allowed" disabled="">
                ...
                {anySocialUrl ? <div className="flex flex-row justify-center mt-4 items-center">
                    {facebookUrl ? <a href={facebookUrl} target="_blank" rel="noopener noreferrer"><Image src="/facebook.png" width="30"></Image></a> : ""}
                    {instagramUrl ? <a href={instagramUrl} target="_blank" rel="noopener noreferrer"><Image src="/instagram.png" width="30"></Image></a> : ""}
                    {githubUrl ? <a href={githubUrl} target="_blank" rel="noopener noreferrer"><Image src="/github.png" width="30"></Image></a> : ""}
                    {linkedinUrl ? <a href={linkedinUrl} target="_blank" rel="noopener noreferrer"><Image src="/linkedin.png" width="30"></Image></a> : ""}
                    {redditUrl ? <a href={redditUrl} target="_blank" rel="noopener noreferrer"><Image src="/reddit.png" width="30"></Image></a> : ""}
                    {snapchatUrl ? <a href={snapchatUrl} target="_blank" rel="noopener noreferrer"><Image src="/snapchat.png" width="30"></Image></a> : ""}
                    {tiktokUrl ? <a href={tiktokUrl} target="_blank" rel="noopener noreferrer"><Image src="/tiktok.png" width="30"></Image></a> : ""}
                    {pinterestUrl ? <a href={pinterestUrl} target="_blank" rel="noopener noreferrer"><Image src="/pinterest.png" width="30"></Image></a> : ""}
                    {twitterUrl ? <a href={twitterUrl} target="_blank" rel="noopener noreferrer"><Image src="/twitter.png" width="30"></Image></a> : ""}
                    {youtubeUrl ? <a href={youtubeUrl} target="_blank" rel="noopener noreferrer"><Image src="/youtube.png" width="30"></Image></a> : ""}
                </div> : ""}
