        ...
        <div className="flex flex-col items-center justify-center mx-4">
            ...
            {loading ? <div type="button" className="inline-flex items-center px-4 py-2 font-semibold leading-6 text-lg transition ease-in-out duration-150 cursor-not-allowed" disabled="">
                ...
                <div className="flex flex-row justify-between mt-6 mb-1 items-center">
                    <CustomLabel style={{ fontSize: "0.775rem" }} className="address-overflow p-0 font-semibold text-sm text-gray-400">{displayedAddress}</CustomLabel>
                    <img onClick={() => { navigator.clipboard.writeText(displayedAddress) }} style={{ height: "16px", width: "16px" }} className="mr-2 sm:mr-4" src="/images/clipboard.png"></img>
                </div>
