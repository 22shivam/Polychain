        ...
        <div className="flex flex-col items-center justify-center h-screen">
            ...
            <div id="card" className="flex flex-col justify-center rounded-xl border border-gray-300 shadow-sm p-6 bg-white">
                ...
                <div className="flex flex-row justify-between mb-4">
                    <CustomLabel className="text-gray-500 text-medium">{USDPerCurrency * payValue}</CustomLabel>
                    <CustomLabel className="text-gray-500 text-medium">{USDPerCurrency}</CustomLabel>
                </div>
