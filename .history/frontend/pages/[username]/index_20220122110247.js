        ...
        <div className="flex flex-col items-center justify-center mx-4">
            ...
            {loading ? <div type="button" className="inline-flex items-center px-4 py-2 font-semibold leading-6 text-lg transition ease-in-out duration-150 cursor-not-allowed" disabled="">
                ...
                <div className="flex flex-row justify-center mt-4">
                    <img style={{ height: "35px" }} src="/images/facebook.svg"></img>
                    <img style={{ height: "35px" }} src="/images/twitter.svg"></img>
                    <img style={{ height: "35px" }} src="/images/reddit.svg"></img>
                    <img style={{ height: "35px" }} src="/images/tiktok.svg"></img>
                    <img style={{ height: "35px" }} src="/images/pinterest.svg"></img>
                    <img style={{ height: "35px" }} src="/images/github.svg"></img>
                    <img style={{ height: "35px" }} src="/images/instagram.svg"></img>
                    <img style={{ height: "35px" }} src="/images/snapchat.svg"></img>
                </div>
