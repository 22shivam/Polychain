...
export default function UserPayment() {
    ...
    const { connector } = useContext(WalletConnectorContext)
    ...
    const transferAmount = async () => {
        try {
            if (selectedCurrency.name == "ETH") {
                await transferEth({ ether: payValue, addr: ETHAddress, setUserAccount: (obj) => { return }, boolCheckIfEthAddressAvailable: false, connector: connector })
            } else if (selectedCurrency.name == "SOL") {
