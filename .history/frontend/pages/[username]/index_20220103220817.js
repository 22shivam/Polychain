...
export default function UserPayment() {
    ...
    return (
        ...
        <div className="flex flex-col items-center justify-center">
            ...
            <CustomButton onClick={() => { window.open("http://localhost:3000/", "_blank") }} className="my-10 bg-brand-primary-medium text-white hover:bg-brand-primary-dark">Get your own!</CustomButton>
