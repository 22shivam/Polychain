    ...
    return (
        ...
        <div className="flex flex-col items-center justify-center">
            <ToastContainer
                ...
                draggable
            />
            <div onClick={() => { window.open("http://localhost:3000/", "_blank") }} className="my-10 cursor-pointer">
                <img src="croppedPolychainLogo.png" width="200"></img>
            </div>
            {loading ? <button type="button" class="inline-flex items-center px-4 py-2 font-semibold leading-6 text-sm shadow rounded-md text-white bg-indigo-500 hover:bg-indigo-400 transition ease-in-out duration-150 cursor-not-allowed" disabled="">
                ...
                Loading...
            </button> : <div id="card" className="flex flex-col justify-center rounded-xl border border-gray-300 shadow-sm p-6 bg-white">
                ...
                <CustomButton onClick={transferAmount} className="mb-6 bg-brand-primary-medium text-white hover:bg-brand-primary-dark">Pay</CustomButton>

            </div>}
            <CustomButton onClick={() => { window.open("http://localhost:3000/", "_blank") }} className="my-10 bg-brand-primary-medium text-white hover:bg-brand-primary-dark opacity-60 rounded-2xl">Get your own!</CustomButton>
