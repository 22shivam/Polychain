        ...
        <Page>
            <div className="flex flex-col align-items-center items-center mt-16">
                ...
                {loading ? <Loading /> : accountExists ?
                    <div id="card" className="transition-all duration-1000 flex flex-col justify-center rounded-xl border border-gray-300 shadow-sm p-3 pt-6 sm:p-6 mx-8 sm:mx-32 bg-white md:mx-40 lg:mx-60">
