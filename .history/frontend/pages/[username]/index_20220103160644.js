...
export default function UserPayment() {
    ...
    return (
        ...
        <div className="flex flex-col items-center justify-items-center my-auto h-screen">
            <div id="card" className="flex flex-col justify-items-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white">
