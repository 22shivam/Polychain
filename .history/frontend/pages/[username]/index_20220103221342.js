        ...
        <div className="flex flex-col items-center justify-center">
            ...
            <div id="card" className="flex flex-col justify-center rounded-xl border border-gray-300 shadow-sm p-6 bg-white">
                ...
                <div class="flex justify-center my-6">
                    ...
                    <div className="flex flex-col">
                        <CustomInput inputmode="decimal" placeholder="Amount" value={payValue} onChange={(e) => { setPayValue(e.target.value) }} name="field_name" className="ml-0 input-placeholder py-4" type="text" />
                ...
                {selectedCurrency.name == "BTC" ? <img className="m-0" src={qrCode}></img> : ""}
