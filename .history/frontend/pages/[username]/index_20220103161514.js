...
export default function UserPayment() {
    ...
    return (
        ...
        <div className="flex flex-col items-center justify-items-center h-screen">
            <div id="card" className="m-auto flex flex-col justify-items-center rounded-md border border-gray-300 shadow-sm px-4 py-10 bg-white">
                <div id="profile_header" className="flex flex-row my-4">
