            ...
            {loading ? <div type="button" class="inline-flex items-center px-4 py-2 font-semibold leading-6 text-lg transition ease-in-out duration-150 cursor-not-allowed" disabled="">
                ...
                <div id="profile_header mt-6" className="flex flex-row">
                    ...
                    <div className="flex flex-col">
                        ...
                        <CustomLabel style={{ fontWeight: "500", maxWidth: "300px", textOverflow: "ellipsis", whiteSpace: "wrap", overflow: "hidden" }} className="px-0">lorem ipsum dolor hehehe alol biral aijf sdhgfbref sdfberfbiu dsfberfuiewfb refiueribufiw wuefiberib wiofheigvbb iowefeorigberi wioefeiorfbn woiferiobg ioweefio</CustomLabel>
                    </div>
                </div>
