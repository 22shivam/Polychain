                ...
                {loading ? <Loading /> : accountExists ?
                    <div id="card" className="flex flex-col justify-center rounded-xl border border-gray-300 shadow-sm p-3 pt-6 sm:p-6 bg-white">
                        <nav className="flex flex-row justify-evenly">
                            <CustomLabel style={{ fontSize: "1.1rem" }} onClick={() => { setActive(1) }} className={active == 1 ? "text-brand-primary-light" : "text-gray-500"}>Pay</CustomLabel>
                            <div className="border border-gray-300"></div>
                            <CustomLabel style={{ fontSize: "1.1rem" }} onClick={() => { setActive(2) }} className={active == 2 ? "text-brand-primary-light" : "text-gray-500"}>Links</CustomLabel>
                        </nav>
