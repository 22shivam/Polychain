...
export default function UserPayment() {
    const { WallectConnectConnector, setWalletConnectConnector } = useContext(WalletConnectorContext);
    ...
    const transferAmount = async () => {
        try {
            if (selectedCurrency.name == "ETH") {
                console.log(WallectConnectConnector)
                await transferEth({ ether: payValue, addr: ETHAddress }, setUserAccount, false, WallectConnectConnector, userAccount)
            } else if (selectedCurrency.name == "SOL") {
