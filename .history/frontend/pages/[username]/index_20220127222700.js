        ...
        <Page>
            <div className="flex flex-col align-items-center items-center mt-16">
                ...
                {loading ? <Loading /> : accountExists ?
                    active == 1 ?
                        <div id="card" className="transition-all duration-1000 flex flex-col justify-center rounded-xl border border-gray-300 shadow-sm p-3 pt-6 sm:p-6 mx-8 sm:mx-28 bg-white md:mx-32">
                            ...
                            {active == 1 ? <div className={active == 1 ? "flex flex-col transition-all duration-1000" : "h-0 duration-1000 transition-all"}>
                            ...
                            {active == 3 ?
                                <div className={active == 3 ? "mt-4 flex flex-wrap justify-center transition-all duration-1000" : "h-0 transition-all duration-1000"}>
                                    {ethNFTs.map(
                                        (nft, index) => {
                        ...
                        </div> : <div id="card" className={active == 1 ? "transition-all duration-1000 flex flex-col justify-center rounded-xl border border-gray-300 shadow-sm p-3 pt-6 sm:p-6 mx-8 sm:mx-28 bg-white md:mx-32" : "h-0"}>
