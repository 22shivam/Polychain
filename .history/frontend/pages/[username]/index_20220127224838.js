                                    ...
                                    (nft, index) => {
                                        ...
                                        return (
                                            <div key={index} className="m-4 mb-8 mx-6 shadow-md rounded-3xl overflow-hidden">
                                                <video onLoad={(e) => { e.target.style.display = "flex"; let name = document.getElementById("nftname" + index.toString()); name.style.display = "block" }} style={{ "display": "none" }} width="300" loop muted onError={(e) => { e.target.style.display = "none" }}>
                                                    <source src={nft.url} type='video/webm' />
                                                </video>
                                                <img onLoad={(e) => { e.target.style.display = "flex"; let name = document.getElementById("nftname" + index.toString()); name.style.display = "block" }} style={{ "display": "none" }} key={index} onError={(event) => { event.target.style.display = 'none' }} src={nft.url} width="300"></img>
