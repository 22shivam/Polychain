...
export default async function transferSOL(solAmount, toAddr) {
    ...
    console.log("after sending transaction:", signature);
    // Confirm whether the transaction went through or not
    const output = await connection.confirmTransaction(signature);
    console.log("confirm transaction output:", output)
}
