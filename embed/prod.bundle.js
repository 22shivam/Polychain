...
button.className = "poly-btn";
if(userInfo.style == "inverted") {
    button.className += " poly-btn-inverted"
}
button.href = `${BASE_URL}/${userInfo.user}`;
...
text.className = "poly-btn-text";
text.appendChild(document.createTextNode(userInfo.text));

button.appendChild(img);
button.appendChild(text);

buttonTarget.parentNode.replaceChild(button, buttonTarget);
