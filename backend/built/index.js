...
app.post("/login/eth", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    console.log(address);
    console.log(message);
    const signer = yield ethers_1.ethers.utils.verifyMessage(message, signature);
...
app.post("/register/sol", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const solPaid = (preBalanceSender - postBalanceSender - fee) / (Math.pow(10, 9));
...
app.post("/register/eth", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const ethPaid = parseInt(txDetailsFromEtherscan.value, 16) / Math.pow(10, 18);
