    ...
    return (
        <footer className="text-gray-700 bg-white body-font text-md">
            <div className="container flex items-center px-8 py-8 mx-auto max-w-7xl sm:flex-row">
                ...
                <p className="sm:ml-4 font-medium sm:pl-4 sm:border-gray-200 sm:mt-0 flex items-center justify-center">{/*© 2021 &nbsp;*/} <Link href="/" target="">Spindl</Link> &nbsp;

                </p>
                <span id="spacer" className="grow"></span>
                <span id="socials"><a href="https://twitter.com/spindlhq" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-gray-500">
