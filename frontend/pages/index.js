...
export default function App() {
    ...
    const registerUsingSolana = async (e) => {
        ...
        try {
            ...
            const hash = await transferSOL(SOLpayValue, "wFQcfUuXkyb7puHS7mSbrjETEhnBDCfdbnLLDftKNLg", setUserAccount, true, userAccount);
            if (!hash) { return }
    ...
    const registerUsingPolygon = async (e) => {
        try {
        ...
        <Page>
            <div id="home" className="pt-12 flex flex-col justify-center items-center mb-40 sm:mb-48 md:mb-52">
                <div id="main_content" className="my-7">
                    ...
                    <div style={{ maxWidth: "500px" }} className="text-center mx-16 mt-7 sm:mt-8 md:max-w-lg md:text-center sm:text-lg font-medium">Replace all your wallet addresses with a simple link! <span className=" text-transparent font-bold bg-clip-text bg-gradient-to-br from-brand-primary-dark to-brand-primary-light sm:inline-block">Get one for free</span> by <a href="https://twitter.com/intent/tweet?original_referer=https://spindl.me/&ref_src=twsrc%5Etfw%7Ctwcamp%5Ebuttonembed%7Ctwterm%5Eshare%7Ctwgr%5E&related=spindlhq&text=claiming%20my%20%40spindlhq%20link!&url=https%3A%2F%2Fspindl.me%2F" target="_blank" rel="noreferrer">tweeting</a> @spindlhq or buy for $5/yr</div>
                </div>
                <div id="username" className="flex flex-col justify-center items-center">
                    <div className="flex justify-center my-3">
                        ...
                        <div className="buyHomePage"><DropDownComponent primaryLabel="Buy" label3="Polygon" label3onClick={registerUsingPolygon} label1="Ethereum" label2="Solana" label1onClick={registerUsingEthereum} label2onClick={registerUsingSolana} /></div>
                    </div>
            ...
            <div className="px-8 mx-auto max-w-7xl lg:px-16 mb-40">
                ...
                <div className="grid grid-cols-1 gap-0 md:grid-cols-2 md:gap-16 font-medium">
                    <div>
                        ...
                        <p>
                            It costs $5/yr. For a limited time, you can get it for free by tweeting anything @spindlhq.
                        </p>
                    </div>
                    <div>
                        <h5 className="mt-10 mb-3 font-semibold text-gray-900">What does the future of Spindl look like?</h5>
                        ...
                        <p>
                            Bitcoin, Ethereum, Solana, and DeSo are currently supported. ERC20 tokens and other popular cryptocurrencies will also be added to the platform in the near future. If you have any recommendations, then drop us a message <a href="https://twitter.com/spindlhq" target="_blank" rel="noreferrer">@spindlhq</a> on twitter.
                        </p>
                        <h5 className="mt-10 mb-3 font-semibold text-gray-900">Have any other questions or suggestions?</h5>
                        <p>Feel free to drop us a message @spindlhq on twitter</p>
